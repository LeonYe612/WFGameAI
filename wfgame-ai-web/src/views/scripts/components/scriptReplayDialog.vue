...
import type { ScriptInfo, ReplayConfig, ReplayRequest } from "@/api/scripts";
    ...
    <div v-loading="loading" class="script-replay-content">
      <div class="space-y-4">
        ...
        <el-card shadow="never" class="border">
          ...
          <div class="space-y-4">
            <div
              v-for="(config, index) in scriptConfigs"
              :key="index"
              class="script-config p-4 bg-gray-50 rounded-lg"
            >
              <div class="flex items-center justify-between mb-3">
                ...
                >
                <el-button
                  v-if="scriptConfigs.length > 1"
                  size="small"
                  type="danger"
                  :icon="Delete"
                  @click="removeScriptConfig(index)"
                  :disabled="loading"
                >
                  移除
                </el-button>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <el-select
                    v-model="config.script_filename"
                    placeholder="请选择脚本"
                    style="width: 100%"
                    filterable
                    :disabled="loading"
