import{p as I,d as M}from"./index-0964a6d0.js";import{s as P}from"./scripts-8ebe9156.js";import{s as T}from"./request-28f7529e.js";import{m as W,r as x,a0 as A,A as r,O as H,j as _,u as V,I as t,l as i,z as s,B as d,y as C,x as w,P as L,k as S,F as G,p as K,aE as u,_ as Q}from"./index-41f05ddf.js";import{s as X}from"./rules-0bcc1e57.js";const Y={class:"script-create-content"},Z={class:"flex items-center"},h={class:"grid grid-cols-1 md:grid-cols-2 gap-4"},ee={class:"flex items-center justify-between"},te={class:"flex space-x-2"},se={class:"flex items-center justify-between"},le={class:"flex space-x-2"},oe={class:"flex justify-between items-center text-sm text-gray-500"},ae={class:"flex justify-end space-x-2"},N=`{
  "name": "新建脚本",
  "version": "1.0",
  "description": "请描述脚本功能",
  "steps": [
