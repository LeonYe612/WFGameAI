import{p as H,d as M}from"./index-52ed101c.js";import{s as T}from"./scripts-c0f2e4d3.js";import{s as W}from"./request-6dd7bfdd.js";import{l as A,r as h,$ as E,z as d,N as L,h as b,q as V,H as t,k as i,y as s,A as r,x as C,v as k,O as P,j as N,F as G,m as K,aF as p,ah as Q,ai as X,_ as Y}from"./index-c3bc70ba.js";import{s as Z}from"./rules-513bd75e.js";const u=m=>(Q("data-v-94951a10"),m=m(),X(),m),ee={class:"script-create-content"},te={class:"flex items-center"},se=u(()=>i("span",{class:"font-medium"},"脚本信息",-1)),ae={class:"grid grid-cols-1 md:grid-cols-2 gap-4"},oe={class:"flex items-center justify-between"},le=u(()=>i("span",{class:"font-medium"},"脚本模板",-1)),ne={class:"flex space-x-2"},ie=u(()=>i("div",{class:"text-sm text-gray-600 mb-3"}," 选择一个模板快速开始，或者直接编辑下方的JSON内容 ",-1)),de={class:"flex items-center justify-between"},re=u(()=>i("span",{class:"font-medium"},"脚本内容",-1)),ce={class:"flex space-x-2"},pe={class:"flex justify-between items-center text-sm text-gray-500"},ue=u(()=>i("span",{class:"text-blue-500"},[i("i",{class:"el-icon-info mr-1"}),r(" 请确保JSON格式正确 ")],-1)),me={class:"flex justify-end space-x-2"},O=`{
  "name": "新建脚本",
  "version": "1.0",
  "description": "请描述脚本功能",
  "steps": [
